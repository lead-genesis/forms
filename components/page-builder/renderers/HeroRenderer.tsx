...
export const HeroRenderer = React.memo(({ data, fontColor, imageUrl, isPreview, brandPages, brandForms, viewport }: HeroRendererProps) => {
    ...
    if (orientation === 'background') {
        return (
            <div
                className="relative overflow-hidden min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] flex flex-col justify-center items-center"
            ...
            >
                ...
                <div className="relative z-[2] max-w-3xl py-16 sm:py-24 lg:py-32 px-4 sm:px-8 lg:px-12 text-center space-y-4 sm:space-y-6">
    ...
    return (
        <div
            className={cn(
                "py-12 sm:py-16 lg:py-24 px-4 sm:px-8 lg:px-12 flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-16 min-h-[400px] sm:min-h-[500px]",
